const STORE_SOCKET_EVENTS = {
  ...
  UPDATE_STORE_SONG_STATS_RECORDS: 'UPDATE_STORE_SONG_STATS_RECORDS'
};
...
const CLIENT_TO_SERVER_EVENTS = {
  ...
  GAME_SKIP_SONG: 'GAME_SKIP_SONG',
  GAME_USE_LIFE_LINE: 'GAME_USE_LIFE_LINE'
};
...
const SERVER_TO_CLIENT_EVENTS = {
  ...
  GAME_SHOW_LIFE_LINE: 'GAME_SHOW_LIFE_LINE'
};

const BOTH_WAY_EVENTS = {
